...
class SadTalker():
    ...
    def test(self, source_image, driven_audio, preprocess='full', 
        still_mode=True,  use_enhancer=True, batch_size=1, size=512, 
        ...
        if source_image == "Female":
            source_image = "/home/akugyo/GitHub/intern/stable/female358.png"
        elif source_image == "Male":
            source_image = "/home/akugyo/GitHub/intern/stable/male19.png"
